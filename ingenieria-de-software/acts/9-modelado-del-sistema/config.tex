...
\usepackage[dvipsnames, table]{xcolor} % Tables support
...
%Figures
\newcommand{\figA}{./img/caso-de-uso.jpg}

\newcommand{\figB}{./img/secuencia\_crear-cuenta.jpg}
\newcommand{\figC}{./img/secuencia\_asesor.jpg}
\newcommand{\figD}{./img/secuencia\_gestion-de-proyectos.jpg}
\newcommand{\figE}{./img/secuencia\_gestion-de-tareas.jpg}

\newcommand{\figF}{./img/actividades\_crear-cuenta.jpg}
\newcommand{\figG}{./img/actividades\_asesor.jpg}
\newcommand{\figH}{./img/actividades\_gestion-de-proyectos.jpg}
\newcommand{\figI}{./img/actividades\_gestion-de-tareas.jpg}

\newcommand{\figJ}{./img/entidad\_relacion.jpg}
\newcommand{\figK}{./img/clases.jpg}
...
\newcommand{\theTitle}{9. Modelado del Sistema}
\newcommand{\profesor}{Morales Ramírez Thelma Isabel}
\newcommand{\seccion}{D07}
\newcommand{\nrc}{210896}
\newcommand{\clave}{CB224}
\newcommand{\startDate}{28 de octubre de 2024}
