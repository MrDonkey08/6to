...
% Figures
\newcommand{\figA}{./img/1-ejecución-del-programa.jpg}
\newcommand{\figB}{./img/2-timestap-value.jpg}
\newcommand{\figC}{./img/3-impresion-de-archivo.jpg}
\newcommand{\figD}{./img/4-impresion-de-fecha.jpg}
...
\newcommand{\theTitle}{5. Manipulación de Archivos, Directorios y Fechas}
\newcommand{\profesor}{José Juan Meza Espinoza}
\newcommand{\seccion}{D02}
\newcommand{\nrc}{209850}
\newcommand{\clave}{IL358}
\newcommand{\startDate}{21 de octubre de 2024}
