...
%% Figures
\newcommand{\sitioWeb}{./img/sitio-web.jpg}
\newcommand{\prototipo}{./img/prototipo.jpg}
...
\newcommand{\theTitle}{5. Aplicación de la Ley de Fitts en el Diseño de Interfaz de Usuario}
\newcommand{\profesor}{José Luis David Bonilla Carranza}
\newcommand{\seccion}{D01}
\newcommand{\nrc}{209754}
\newcommand{\clave}{IL367}
\newcommand{\startDate}{15 de octubre de 2024}
