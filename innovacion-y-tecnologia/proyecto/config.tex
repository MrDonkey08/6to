...
\usepackage[margin=2.5cm, left=3cm, includefoot]{geometry}
...
% Figures
\newcommand{\figA}{./img/2-red-de-clientes.jpg}
\newcommand{\figB}{./img/4-mapa-del-modelo-de-negocio.jpg}
\newcommand{\figC}{./img/5-tren-de-valor-competitivo.jpg}
...
\newcommand{\theTitle}{Proyecto Final}
\newcommand{\profesor}{Ascencio Piña César Rodolfo}
\newcommand{\seccion}{D04}
\newcommand{\nrc}{209856}
\newcommand{\clave}{IL351}
\newcommand{\generation}{2024B}
\newcommand{\startDate}{29 de noviembre de 2024}
